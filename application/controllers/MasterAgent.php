...
class MasterAgent extends CI_Controller{
  ...
  public function Dashboard()
  {
    if($_SESSION['UserTypeID']==4){
			$this->load->view('master_agent/template/header_template_view.php');
			$this->load->view('master_agent/master_agent_dashboard_view');
			$this->load->view('master_agent/template/footer_template_view.php');
		}else{
  ...
  public function SubAgent()
  {
    if($_SESSION['UserTypeID']==4){
			$this->load->view('master_agent/template/header_template_view.php');
			$this->load->view('master_agent/sub-agent_list_view');
			$this->load->view('master_agent/template/footer_template_view.php');
		}else{
			header("Location:".site_url()."/Welcome");
		}
  ...
  public function Player()
  {
    if($_SESSION['UserTypeID']==4){
			$this->load->view('master_agent/template/header_template_view.php');
			$this->load->view('master_agent/player_list_view');
			$this->load->view('master_agent/template/footer_template_view.php');
		}else{
			header("Location:".site_url()."/Welcome");
		}
  ...
  public function PlayerInfo($id)
  {
    ...
    if($_SESSION['UserTypeID']==4&&$info['info']->RecruiterID==$_SESSION['UserID']){
      $this->load->view('master_agent/template/header_template_view.php',$info);
      $this->load->view('master_agent/player_info_view.php');
      $this->load->view('master_agent/template/footer_template_view.php');
    }else{
      header("Location:".site_url()."/Welcome");
    }
  ...
  public function SubAgentInfo($id)
  {
    ...
    if($_SESSION['UserTypeID']==4&&$info['info']->RecruiterID==$_SESSION['UserID']){
      $this->load->view('master_agent/template/header_template_view.php',$info);
      $this->load->view('master_agent/sub-agent_info_view.php');
      $this->load->view('master_agent/template/footer_template_view.php');
    }else{
      header("Location:".site_url()."/Welcome");
    }
  ...
  public function WalletDeposit()
	{
		if($_SESSION['UserTypeID']==4){
			$this->load->view('master_agent/template/header_template_view.php');
			$this->load->view('master_agent/wallet_deposit_view');
			$this->load->view('master_agent/template/footer_template_view.php');
		}else{
			header("Location:".site_url()."/Welcome");
		}
